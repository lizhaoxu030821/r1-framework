...
```bash
# 从训练输出目录加载模型（示例路径）
python robolab/scripts/mujoco/sim2sim_atom01.py --load_model "logs/rsl_rl/atom01_amp/<EXP_NAME>/model_<STEP>.pt"
```
conda activate robo_lzx
cd /home/a/lzx/roboto_origin/modules/atom01_train
python robolab/scripts/mujoco/sim2sim_atom01.py \
  --load_model "logs/rsl_rl/atom01_amp/2026-03-16_17-46-37/model_4999.pt"
