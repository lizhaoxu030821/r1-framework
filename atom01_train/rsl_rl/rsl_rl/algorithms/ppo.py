...
class PPO:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        optimizer = optimizer.lower() if isinstance(optimizer, str) else "adam"
        if optimizer == "adam":
            ...
            raise ValueError(f"Unsupported optimizer '{optimizer}'. Supported optimizers are: 'adam', 'adamw', 'sgd', 'rmsprop'.")
